...
def main(args):
    ...
    for r in [0,1,2,3,4]:#[5,6,7,11,12]: #[0,1,2,3,4]
        ...
        for config in configurations:
            ...
            curve_name_prepends = [r'$\bf{GNN-SS-UCB} $', r'$\bf{GNN-SS-TS} $', r'$\bf{GP-SS-UCB} $', r'$\bf{GP-SS-TS} $']
            ...
            axes_cal[row_counter][1].errorbar(alpha_sharpness_str, np.mean(avg_widhts, axis=0), yerr=np.std(avg_widhts, axis=0), fmt='o', markersize=4, capsize=8, color = clr)
